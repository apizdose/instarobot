...
def checkuser(username):
    ...
    with requests.Session() as s:
      ...
      r = s.get(link, headers = headers, proxies=proxies, verify=False)
    ...
    if likable:
        ...
        try:
            with requests.Session() as s:
                ...
                r = s.post(linklike,headers=headers, proxies=proxies, verify=False)
            ...
            try:
                ...
                if spamlike:
                    ...
                    if not likepost:
                        print("  >>> FOLLOWED!....  "+str(counter)+' by '+loginform)
...
if __name__ == '__main__':
    ...
    with open(f'{base}','r',encoding='utf-8') as csvfile:
            ...
            for row in reader:
                    try:
                            if not spam:
                                    ...
                                    identme()
                                    if counter == 40 or counter == 80 or counter == 160 or counter == 240 or counter==320:
                                        time.sleep(43000)
                            ...
                            exceptn = str(err)
                            print(exceptn)
                            if 'proxy' in exceptn or 'Proxy' in exceptn:
